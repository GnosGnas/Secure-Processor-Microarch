#include<stdio.h>
#include"lib/clefia_t_table.c"


int main(void)
{
  unsigned char skey[32] = {0xd0U, 0x11U, 0x7cU, 0xe0U, 0xc8U, 0x8bU, 0x89U, 0x5cU, 0x0aU, 0xd0U, 0x8bU, 0x0fU, 0x67U, 0x00U, 0xc6U, 0x0eU};
  ...
  for(int i=0;i<20;i++)
  {
    ClefiaEncrypt(ct, plaintext[i], rk, 18);
    for(int j=0;j<16;j++)
    {
